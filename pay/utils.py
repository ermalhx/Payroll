...
def calculate_payroll_Bruto(gross_salary):
    net_salary = 0
    sp = 0
    sm = 0
    shp = 0
...
def calculate_payroll_Pa_Deklarate(gross_salary):
    net_salary = 0
    sp = 0
    sm = 0
    shp = 0
    ...
    if gross_salary<0:
        ...
        tap = (gross_salary) * 0.13
        net_salary = gross_salary - sm - shm - tap
    elif gross_salary > fasha2 and gross_salary <= fasha3:
        sp = gross_salary * 0.15
        sm = gross_salary * 0.095
        pg_kontributeve = gross_salary
        tot_sig = sp + sm
        ...
        tap = (gross_salary) * 0.13
        net_salary = gross_salary - sm - shm - tap
    elif gross_salary > fasha3 and gross_salary <= pagamax:
        sp = pagamax * 0.15
        sm = pagamax * 0.095
        pg_kontributeve = gross_salary
        tot_sig = sp + sm
        shp = gross_salary * 0.017
        shm = gross_salary *0.017
        tap = (gross_salary - fasha3) * 0.23 + fasha3 *0.13
        net_salary = gross_salary - sm - shm - tap
    elif gross_salary > pagamax:
        sp = pagamax * 0.15
        sm = pagamax * 0.095
        pg_kontributeve = pagamax
        tot_sig = sp + sm
        shp = gross_salary * 0.017
        shm = gross_salary *0.017
        tap = (gross_salary-170000) * 0.23 + fasha3 *0.13
        net_salary = gross_salary - sm - shm - tap
