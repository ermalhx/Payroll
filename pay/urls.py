...
urlpatterns = [
   path('bruto/', views.upload_payroll_preview, name='bruto'),
   ...
   #path('download_payslip/<str:employee_id>/', views.generate_payslip_pdf, name='download_payslip'),
   path('', views.salary_calculator_view, name='calculation'),
]